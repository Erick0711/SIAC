        ...
        <ul class="app-menu">
            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-clipboard"></i><span class="app-menu__label">Expensa</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    ...
                    <li><a class="treeview-item" href="./articulo.php"><i class="icon fa fa-circle-o"></i>Gastos comunes</a></li>
                </ul>
            </li>
            <!-- RECINTO - TABLA - FORMULARIO -->
            <li><a class="app-menu__item" target="_blank" href="./recinto.php"><i class="app-menu__icon fa fa-car"></i><span class="app-menu__label">Recinto</span></a></li>
            </li>
            <!-- RECINTO - TABLA - FORMULARIO -->
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-usd"></i><span class="app-menu__label">Reporte</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="table-basic.php"><i class="icon fa fa-circle-o"></i>Pagos</a></li>
                    <li><a class="treeview-item" href="table-data-table.php"><i class="icon fa fa-circle-o"></i>Cuenta Nominal</a></li>
                </ul>
            </li>
